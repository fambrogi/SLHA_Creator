...
Mothers   = [ i*Mother_Binning for i in range(1,40) if i*Mother_Binning < Mother_Max and i*Mother_Binning > Mother_Min]
Daughters = [ i*Daughter_Binning for i in range(1,40) if i*Daughter_Binning < Daughter_Max ]
